...
public class MediaBuffer extends Activity implements OnInfoListener,
...
//	private SurfaceHolder holder;
	...
	public void onCreate(Bundle icicle) {
		...
		mPreview = (VideoView) findViewById(R.id.buffer);
		mPreview.setVideoLayout(VideoView.VIDEO_LAYOUT_SCALE, 0);
	...
	public class MyAsyncTask extends AsyncTask<String, String, String> {
		...
		protected void onPostExecute(String result) {
			...
			if (path == "") {
				...
				Toast.makeText(MediaBuffer.this, "No stream sources",
				...
				if(h2 != null){
					h2.removeCallbacks(mediaRunnable);
					h2.post(mediaRunnable);
//					playVideo(path);
				}
...
//													mVideoView.setVideoURI(uri);
				...
				Toast.makeText(MediaBuffer.this, "No other sources",
						Toast.LENGTH_SHORT).show();
			}
...
//			mMediaPlayer.setDisplay(holder);
	...
	private void startVideoPlayback() {
		Log.v("debug", "startVideoPlayback");
